...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Julius+Sans+One&family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&display=swap" rel="stylesheet">
...
<body class="h-full bg-white">
    ...
    <div class="flex flex-col min-h-screen pb-32 lg:pb-0">
        ...
        <div class="flex-auto bg-primary">
            <div>
                <svg width="1040" height="986" viewBox="0 0 1040 986" fill="none" xmlns="http://www.w3.org/2000/svg" class=" absolute right-0 z-10">
                ...
                <div class=" block px-5 py-10 z-30 ">
                    {{ $slot }}

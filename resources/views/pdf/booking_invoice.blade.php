...
<body>
    <div class="py-6 container-fluid min-vh-100 d-flex align-items-center justify-content-center ">
        <div class="p-4 bg-white rounded " style="max-width: 49rem; margin: auto;min-width:40rem">
            ...
            <table>
                <tr>
                    <td class="pr-5 "><p><strong>BILLED TO</strong></p></td>
                ...
                <tr>
                    <td class="pr-5 "><p>Account Name</p></td>
                    <td><p class="fs-3">{{ $account_payment ?? '' }}</p></td>
                </tr>
                <tr>
                    <td class="pr-5 "><p>Payment Email</p></td>
                    ...
                    <div class="mt-3 table-responsive">
                        <table class="table table-borderless table-sm">
                            ...
                            <tbody>
                                ...
                                @endphp
                                <tr>
                                    <th class="text-wrap">({{ $order['service']['category']['name_service_categori'] }}) {{ $order['name_service'] }}</th>
                            ...
                            <tfoot>
                                ...
                                @else
                                <tr class="border-top">
                                    <td colspan="3" ><p class="fs-1">Total</p> </td>
                                    <td class="text-right"><p>${{ $total_price - $deposit_price }}</p></td>
                                </tr>
                                @endif
                            </tfoot>
                        </table>

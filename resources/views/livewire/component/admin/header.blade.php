<div>
    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.homepage-images') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Homepage Images</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('admin.reports') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Sales Reports</span>
                    </a>
                </li>
                <li>
    ...
    <div class="p-5 bg-gray-50 sm:ml-64">
        <div class="flex justify-end gap-5">
                ...
                <div class="relative">
                    ...
                    <div id="dropdown"
                        ...
                        <ul class="overflow-y-auto h-52">
                            ...
                            @else
                                <li>
                                    <h1 class="py-5 font-semibold text-center">There is no new notification</h1>
                                </li>
                            @endif
                        </ul>
                        <!-- View More Link -->
            ...
            <div class="">
                <button type="button"
                    class="inline-flex items-center p-2 mt-2 bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"

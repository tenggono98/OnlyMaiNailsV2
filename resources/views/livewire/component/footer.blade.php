<div>
    ...
    <div class="grid gap-5 px-10 py-10 lg:px-20 lg:grid-cols-4">
        ...
        <div class="">
            ...
            <ul>
                <li>
                    <a target="_blank" href="https://www.instagram.com/onlymainails/" class="flex items-center gap-1 align-middle">
                        <div class="">
            ...
            <ul class="">
                ...
                <li class="mb-3">
                    <a target="_blank" href="https://mail.google.com/mail/u/0/
                        ...
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-auto h-7">

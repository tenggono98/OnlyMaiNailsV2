<div>
    ...
    <div class="relative mb-2">
        <input type="text" id="search" wire:model.live="searchTerm"
            class="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-lg g-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Search client...">
        @if ($clientBook)
            <button wire:click="clearSelection" type="button"
                class="absolute top-0 right-0 px-4 py-1 mt-2 mr-2 text-white bg-red-500 rounded-md hover:bg-red-600 focus:outline-none">Cancel</button>
        @endif
    </div>
